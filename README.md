...
## Step 5:
Publish the website in the given URL : http://ishu.student.saveetha.in/
...
<style>
    *{
    ...
    margin-right: auto;
    border-radius: 25px;
    border: 10px solid rgb(27, 144, 212);
    box-shadow: inset 0 0 15px rgb(173, 21, 21);
    background-color:rgb(30, 228, 63);
    }
    h1{
        text-align: center;
        padding-top: 15px;
